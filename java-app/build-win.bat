...
set JAVA_VERSION=23
set MAIN_JAR=dBPlotter-%PROJECT_VERSION%.jar
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\com\dlraudio\dbplotter\MainApp.class > temp.txt
...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --icon src/main/resources/com/dlraudio/ui/icons/icon.ico ^
